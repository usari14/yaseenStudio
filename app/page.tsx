    ...
    <SmoothScroll>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 h-16 sm:h-20 flex items-center justify-between">
          <div className="text-lg sm:text-xl md:text-2xl font-light tracking-[0.1em] sm:tracking-[0.2em] uppercase">
      ...
      <ScrollSequence frameCount={50}>
        <div
          className="relative z-10 text-center px-4 sm:px-6 md:px-8 lg:px-16 py-8 sm:py-12 md:py-16 max-w-4xl mx-auto mt-12 sm:mt-16 md:mt-20 bg-white/70 backdrop-blur-md shadow-2xl rounded-2xl sm:rounded-3xl border border-white pointer-events-auto"
        >
          <div className="flex justify-center mb-4 sm:mb-6">
            <Scissors className="w-6 sm:w-8 h-6 sm:h-8 text-black/80" strokeWidth={1} />
          </div>
          <h2 className="text-black text-[10px] sm:text-xs md:text-sm tracking-[0.3em] sm:tracking-[0.4em] font-light uppercase mb-4 sm:mb-6">Heritage & Craft</h2>
          <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-light tracking-tighter mb-4 sm:mb-8 leading-[1]">
            THE <span className="font-serif italic block mt-1 sm:mt-2 text-black">CLASSIC</span> CUT
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-black/70 font-light max-w-xl mx-auto mb-8 sm:mb-12 tracking-wide leading-relaxed">
            Reviving traditional barbering with modern precision. A sanctuary for the modern gentleman.
          </p>
          <a
            href="#services"
            className="inline-block border border-black text-black px-6 sm:px-8 md:px-10 py-3 sm:py-4 uppercase tracking-[0.2em] text-[10px] sm:text-xs hover:bg-black hover:text-white transition-all duration-500 bg-transparent pointer-events-auto"
          >
            Explore Services
          </a>
        </div>
        ...
        <motion.div 
          ...
          className="absolute bottom-4 sm:bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2"
        >
          <span className="text-[8px] sm:text-[10px] uppercase tracking-[0.3em] sm:tracking-[0.4em] text-white/40 font-light">Scroll to explore</span>
          <div className="w-px h-8 sm:h-12 bg-linear-to-b from-white/40 to-transparent relative overflow-hidden">
            <motion.div 
              className="absolute top-0 left-0 w-full bg-white h-4"
              animate={{ y: [0, 48, 0] }}
